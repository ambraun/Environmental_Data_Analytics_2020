...
\NormalTok{GaringerOzone2010 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2010_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2011 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2011_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2012 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2012_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2013 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2013_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2014 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2014_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2015 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2015_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2016 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2016_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2017 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2017_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2018 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2018_raw.csv"}\NormalTok{)}
\NormalTok{GaringerOzone2019 <-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2019_raw.csv"}\NormalTok{)}

\KeywordTok{dim}\NormalTok{(GaringerOzone2011)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# 2 }
\NormalTok{GaringerOzone <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(GaringerOzone2010, GaringerOzone2011, GaringerOzone2012, }
...
\begin{Highlighting}[]
\CommentTok{# 4}
\NormalTok{GaringerOzone <-}\StringTok{ }\KeywordTok{select}\NormalTok{(GaringerOzone, Date, Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration, DAILY_AQI_VALUE)}

\CommentTok{# 5}
\NormalTok{Days <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{( }\KeywordTok{seq}\NormalTok{(}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2010-01-01"}\NormalTok{), }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2019-12-31"}\NormalTok{), }\DataTypeTok{by =} \StringTok{"1 day"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{OzonePlot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(GaringerOzone) }\OperatorTok{+}\StringTok{  }
\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Date, }\DataTypeTok{y =}\NormalTok{ Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration)) }\OperatorTok{+}\StringTok{ }
\StringTok{                  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Date"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Ozone (ppm)"}\NormalTok{, }\DataTypeTok{color =} \StringTok{""}\NormalTok{) }
...
\begin{quote}
Answer: Linear interpolation is best method when short periods of
...
\begin{quote}
Answer: Ozone varies seasonally throughout the year and the Mann-Kndall
tests verify whether a monotonic trend exists taking seasonal variation
into account.
\end{quote}
...
\CommentTok{# 9}
\NormalTok{GaringerOzone.monthly <-GaringerOzone }\OperatorTok{%>%}
...
\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{MeanOzone =} \KeywordTok{mean}\NormalTok{(Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration))}
...
\KeywordTok{summary}\NormalTok{(GaringerOzone.monthly.ts)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
## 0.02342 0.03380 0.04335 0.04149 0.04915 0.06623
\end{verbatim}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Date"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Ozone (ppm)"}\NormalTok{) }\OperatorTok{+}
...
\begin{quote}
Mean ozone shows asignificant decreasing monotonic trend between 2010
and 2019 (z = -1.963, p-value = 0.04965).
\end{quote}
