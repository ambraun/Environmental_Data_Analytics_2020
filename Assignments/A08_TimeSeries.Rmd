...
> Answer: Linear interpolation is best method when short periods of missing data are present.  
...
> Answer: Ozone varies seasonally throughout the year and the Mann-Kndall tests verify whether a monotonic trend exists taking seasonal variation into account. 
...
> Mean ozone shows asignificant decreasing monotonic trend between 2010 and 2019 (z = -1.963, p-value = 0.04965). 
