...
* Manual copy-paste
* API (retrieve data from standard code; data must be in prescribed format) (facebook has an API)
* DOM parsing
...
```
## defining which website to pull from and then defining an object 
...
##R Vest help function within R Studio is good 
...
Notice there are some instances where symbols appear in cells where there should just be numbers or NAs. Let's fix this. #no data is in as a charactrer vector - not N/A 
...
##Could save data frame as a CSV at this point
