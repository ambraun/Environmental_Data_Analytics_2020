...
#install.packages(lubridate), cant knit with an install packages line 
...
#within the matrix, select depth where rows = 0, in matrix notation specific rows and columns need to put comma to signify you want columns 
