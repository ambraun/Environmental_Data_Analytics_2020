...
#verify that our data is not fit on a normal T (?) plot 
...
#better to include this type of plot in a report, not a Q test 

#geomdensity (state = "count") shows the actual count, based on how thick you want the bins to be 

#geomdensity(fill = "Gray") moving average of the distribution, smoothing across the dataset 
...
#not normal distribution because p values are very low 
# tilde ~ means "BY" 
...
#p-value - can grab a specific element from a test, instead of the whole output of the t.test 
